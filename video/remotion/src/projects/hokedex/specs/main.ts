...
export const scenes: SceneSpec[] = [
  ...
  },
  {
    type: 'screenshot',
    duration: 1.2,
    src: 'hokedex/search.png',
    enter: { type: 'slide', direction: 'up' },
  },
  {
    type: 'slideshow',
    duration: 4.4,
    images: ['hokedex/insights2.png', 'hokedex/insights3.png'],
...
// Thin wrapper so VideoPlayer gets scenes + videoConfig as props
const HokedexMain: React.FC = () =>
  React.createElement(VideoPlayer, { scenes, videoConfig });

export const mainComposition = {
  id:               'HokedexMain',
  component:        HokedexMain,
